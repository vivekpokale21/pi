...
def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(
		description="Serve CodeRankEmbed through a small OpenAI-compatible embeddings API.",
	)
...
def main() -> None:
	...
	if args.device == "cuda" and not torch.cuda.is_available():
		raise RuntimeError("CUDA embedding device requested, but torch.cuda.is_available() is false")
